...
interface ProductApiService {
    ...
    suspend fun getProducts(
        ...
        @Query("has_discount") has_discount: Boolean? = null,
        @Query("online_only") online_only: Boolean? = null,
        @Query("active_only") active_only: Boolean? = true,
        @Query("as_of_date") asOfDate: String? = null,
        @Query("available_from_min") availableFromMin: String? = null,
        @Query("available_from_max") availableFromMax: String? = null,
